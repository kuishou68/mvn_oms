                ...
                <div class="fixed-table-toolbar">
                    <div class="bs-bars pull-left">
                        <div class="btn-group-sm" id="toolbar" role="group">
                            <a class="btn btn-success" href="customer_add.jsp" onclick="$.operate.addTab()">
                                <i class="fa fa-plus"></i> 新增
                            </a>
                            <a class="btn btn-primary single disabled" href="user_update.html"
                        ...
                        <table id="bootstrap-table" class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr data-index="${user.cid}">
                                    ...
                                    <td style="" data-field="userId" name="cid" tabindex="0">
                                            ${user.cid}
                                        <div class="fht-cell"></div>
                                    </td>
                                    <td style="" data-field="userName" name="cnam" tabindex="0">
                                            ${user.cnam}
                                        <div class="fht-cell"></div>
                                    </td>
                                    <td style="" data-field="nick_name" name="cadd" tabindex="0">
                                            ${user.cadd}
                                        <div class="fht-cell"></div>
                                    </td>
                                    ...
                                    <td style="" data-field="dept.deptName" name="cmai" tabindex="0">
                                            ${user.cmai}
                                        <div class="fht-cell"></div>
                                    </td>

                                    <td style="" data-field="createTime" name="create_time" tabindex="0">
                                        <a class="btn btn-success btn-xs " href="CustomerSelectServlet?id=${user.cid}"
                                           id="modify"
                                           onclick="$.operate.editTab('7')"><i
                                                class="fa fa-edit"></i>编辑</a> <a class="btn btn-danger btn-xs "
                                                                                 href="CustomerDeleteServlet?id=${user.cid}"
