...
<div id="wrapper">
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="user.html"><i class="fa fa-user"></i> <span class="nav-label">用户管理</span><span
                            class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="main-content">
            <form id="form-user-add" class="form-horizontal" novalidate="novalidate" action="ApplicantUserUpdateServlet" method="post">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input name="user_name" placeholder="请输入用户名称" value="${user.user_name}"
                                       class="form-control" type="text" maxlength="30" required="" aria-required="true">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="email" name="email" class="form-control email" value="${user.email}"
                                       type="text" maxlength="20" placeholder="请输入邮箱" required="" aria-required="true">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="phonenumber" name="phoneNumber" value="${user.phoneNumber}"
                                       placeholder="请输入手机号码" class="form-control" type="text" maxlength="11" required=""
                                       aria-required="true">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select  name="sex" class="form-control m-b select2-hidden-accessible"
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="loginName" name="loginName" placeholder="默认为邮箱登录" value=" ${user.email}"
                                       class="form-control" type="text" maxlength="30" required="" aria-required="true">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label class="toggle-switch switch-solid">
                                    <input type="checkbox" value="${user.status}" id="status" checked="">
                                    <span></span>
                                </label>
                            </div>
                        </div>
