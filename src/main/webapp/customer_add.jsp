...
<div id="wrapper">
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="user"><i class="fa fa-user"></i> <span class="nav-label">用户管理</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="main-content">
            <form id="form-user-add" class="form-horizontal" novalidate="novalidate" action="CustomerAddServlet" method="post">
